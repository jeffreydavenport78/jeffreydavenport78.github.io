...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('#container01 > .wrapper > .inner', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#container02 > .wrapper > .inner', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#container10 > .wrapper > .inner', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#container05 > .wrapper > .inner', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#container03 > .wrapper > .inner', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
